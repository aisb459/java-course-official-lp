...
public class WeatherController {
    ...
    public String getTemperature(@PathVariable String country, @PathVariable String city) {
        kafkaTemplate.send("weather-topic", country, city);//key,value return "%s posted to kafka".formatted(city);
        return "key =%s with value = %s posted to kafka".formatted(country, city);
    }
